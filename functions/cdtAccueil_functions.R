...
tkgrid(frame_msg,row=4,column=0,sticky='nswe',rowspan=6,columnspan=20,padx=1,pady=1,ipadx=1,ipady=1)
tkgrid(frame_img,row=4,column=20,sticky='nswe',rowspan=6,columnspan=40,padx=1,pady=1,ipadx=1,ipady=1)
