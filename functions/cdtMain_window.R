...
cdt.lcmd.container <- list('lcmd.frame_homo', 'lcmd.frame_qc', 'lcmd.frame_chk', 'lcmd.frame_extrdata', 'lcmd.frame_assdata',
						...
						'lcmd.frame_filtercdtdat', 'lcmd.frame_climdexRR', 'lcmd.frame_climdexTT', 'lcmd.frame_spatialAnalysis',
						...
						'lcmd.frame_dailyRainAnalysis', 'lcmd.frame_summariesData', 'lcmd.frame_SPIData')
