...
cusum.s <- function(x){
	Vcritic <- matrix(c(90.0, 1.224, 95.0, 1.358, 97.5, 1.480, 99.0, 1.628, 99.9, 1.949), ncol = 2, byrow = TRUE)
	nl <- length(x)
	ilen <- 1:nl
	ilen <- ilen[!is.na(x)]
	x <- x[!is.na(x)]
...
cusum.sh <- function(x, h){
	Vcritic <- matrix(c(NA, 0.010, 0.025, 0.050, 0.100,
		...
		99.9, 19.278, 18.890, 18.377, 17.741), nrow = 6, byrow = TRUE)
	nl <- length(x)
	ilen <- 1:nl
	ilen <- ilen[!is.na(x)]
	x <- x[!is.na(x)]
...
cusum.t <- function(x){
	Vcritic <- matrix(c(90.0, 0.836, 95.0, 0.906, 97.5, 0.970, 99.0, 1.047, 99.9, 1.222), ncol = 2, byrow = TRUE)
	nl <- length(x)
	ilen <- 1:nl
	ilen <- ilen[!is.na(x)]
	x <- x[!is.na(x)]
...
cusum.th <- function(x, h){
	Vcritic <- matrix(c(NA, 0.010, 0.025, 0.050, 0.100,
		...
		99.9, 20.600, 20.218, 20.114, 19.758), nrow = 6, byrow = TRUE)
	nl <- length(x)
	ilen <- 1:nl
	ilen <- ilen[!is.na(x)]
	x <- x[!is.na(x)]
