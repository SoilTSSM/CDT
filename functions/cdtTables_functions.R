...
displayTable <- function(parent,tclArray=NULL,colwidth="10"){
	...
	resizeborders="both",colorigin=0,roworigin=0,
	highlightcolor="blue",anchor="nw",drawmode="single",colwidth=colwidth,
	colstretchmode="all",rowstretchmode="all",foreground="black",
	rowseparator="\n",colseparator="\t",
	selecttitle=1,cache=1,validate=1,highlightthickness=0,
