...
The menu `r menuselection('Merging Data','Filling missing dekadal temperature values')` allows to fill the missing values of dekadal temperature data using a downscaled and bias corrected reanalysis as predictors.
